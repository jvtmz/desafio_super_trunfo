...
// Quarto Passo - Início da solictação dos dados para preenchimento pelo usuário  - conjunto 1
    ...
    printf("Digite o número de habitantes da cidade (não utilize pontos ou vírgulas):\n");
    scanf("%d",&populacao1);
    printf("Confirmado! A população da cidade é de: %d pessoas. \n\n",populacao1);

    printf("Digite a área da cidade em Km2 (não utilize pontos ou vírgulas): \n");
    scanf("%f",&area1);
    ...
    scanf("%f",&pib1);
    printf("Confirmado! O PIB da cidade é de: R$: %.2f bilhões de reais. \n\n", pib1);
